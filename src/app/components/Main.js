...
export default function Main() {
  return (
    <div className=" background w-full h-screen overflow-hidden relative bg-mountain bg-center bg-cover bg-no-repeat flex justify-center items-center bg-fixed">
      ...
      <h2
        className=" text-white font-extrabold absolute text-center text-7xl font-mono text [text-shadow:_3px_4px_3px_rgb(0_0_0_/_80%)] drop-shadow-xl shadow-slate-800"
        id="text"
      >
        The West Mountains
        <br />
        <span className=" text-2xl font-sans">It is better with mountains</span>
      </h2>
    </div>
  );
}
